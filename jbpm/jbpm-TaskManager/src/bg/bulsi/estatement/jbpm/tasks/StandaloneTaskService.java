package bg.bulsi.estatement.jbpm.tasks;
...
public class StandaloneTaskService {
    ...
    public static void main(String[] args) {
        EntityManagerFactory emf = Persistence.createEntityManagerFactory("bg.bulsi.jbpm.task");
        TaskService taskService = new TaskService(emf, SystemEventListenerFactory.getSystemEventListener());
        TaskServiceSession taskSession = taskService.createSession();
        // Add users
//        Map vars = new HashMap();
//        Reader reader = new InputStreamReader( StandaloneTaskService.class.getResourceAsStream( "LoadUsers.mvel" ) );     
//        Map<String, User> users = ( Map<String, User> ) eval( reader, vars );   
//        for ( User user : users.values() ) {
//            taskSession.addUser( user );
//        }           
//        reader = new InputStreamReader( StandaloneTaskService.class.getResourceAsStream( "LoadGroups.mvel" ) );      
